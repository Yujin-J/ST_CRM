...
export const InteractionEdit = () => {
  ...
  const { data: interactionData, isLoading: isInteractionLoading } = useOne({
  ...
  const { data: contactsData, isLoading: isContactsLoading } = useList({
    resource: "contact",
  });
